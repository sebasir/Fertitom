...
public class MediaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!simulationId.isEmpty() && !assetId.isEmpty() && !tab.isEmpty() && (Util.Constant.SOIL_RESULT_FILE.equals(tab) || Util.Constant.PLANT_RESULT_FILE.equals(tab) || Util.Constant.CLIMATE_RESULT_FILE.equals(tab))) {
